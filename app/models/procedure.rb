...
class Procedure < ApplicationRecord
  ...
  has_many :types_de_piece_justificative, -> { ordered }, dependent: :destroy, inverse_of: :procedure
  has_many :types_de_champ, -> { root.public_only.ordered }, dependent: :destroy, inverse_of: :procedure
  has_many :types_de_champ_private, -> { root.private_only.ordered }, class_name: 'TypeDeChamp', dependent: :destroy, inverse_of: :procedure
